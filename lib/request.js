...
var req = function req(_ref2) {
  var csrfToken = _ref2.csrfToken,
      ...
      _ref2$options$method = _ref2$options.method,
      method = _ref2$options$method === undefined ? 'system' : _ref2$options$method,
      _ref2$options$endpoin = _ref2$options.endpoint,
      endpoint = _ref2$options$endpoin === undefined ? 'ping' : _ref2$options$endpoin,
      _ref2$options$post = _ref2$options.post,
      post = _ref2$options$post === undefined ? false : _ref2$options$post,
      _ref2$options$body = _ref2$options.body,
      body = _ref2$options$body === undefined ? '' : _ref2$options$body,
      attr = _ref2$options.attr;
